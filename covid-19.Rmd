...
-----------------------------------------------------------------------
### 
Last updated on `r renderText({format(daily_indicators$DateVal, '%d %B %Y')})`
...
### Daily new and cumulative confirmed deaths
```{r}
renderPlot({
...
<br/>
<div class = "about">
This dashboard visualises daily confirmed coronavirus cases and deaths published by <a href="https://www.gov.uk/government/publications/covid-19-track-coronavirus-cases" target="_blank">Public Health England</a>. Daily confirmed deaths derive from time series data collated by <a href="https://github.com/emmadoughty/Daily_COVID-19" target="_blank">Emma Doughty</a>.     

Please note that the number of confirmed coronavirus cases is likely to be much lower than the total number of cases because some people who report symptoms are not being tested.      

Further information about Coronavirus (COVID-19) can be found at: <a href="https://www.gov.uk/coronavirus" target="_blank">https://www.gov.uk/coronavirus</a>
</div>