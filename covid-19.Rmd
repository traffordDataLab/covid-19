...
<strong>Confirmed UK cases of COVID-19 as of 09:00 (GMT) on `r renderText({format(daily_indicators$DateVal, '%d %B %Y')})`</strong><br/>Please note that the number of confirmed cases is likely to be much lower than the total number of cases because some people who report symptoms are not being tested.
